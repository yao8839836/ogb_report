...
os.system("pip install torch>=1.6")
os.system("pip install torch-geometric>=1.6.0")
os.system("pip install numpy>=1.16.0")
os.system("pip install pandas>=0.24.0")
os.system("pip install ogb>=1.2.4")
...
def parse_args(args=None):
    ...
    parser.add_argument('-save', '--save_path', default="dataset/ogbl_wikikg2/with_text/", type=str)
...
def main(args):
    ...
    dataset = LinkPropPredDataset(name=args.dataset, root="dataset")
